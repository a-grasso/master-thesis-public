...
You can then execute your native executable with: `./target/merchant-1.0-SNAPSHOT-runner`
...
- Hibernate ORM ([guide](https://quarkus.io/guides/hibernate-orm)): Define your persistent model with Hibernate ORM and
  Jakarta Persistence
- Funqy AWS Lambda Binding ([guide](https://quarkus.io/guides/funqy-aws-lambda)): Amazon Lambda Binding for Quarkus
  Funqy framework
